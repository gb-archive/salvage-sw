...
void part2(VOID) banked {
    ...
    TstCond (Failure, (ThirtyTwo - TwentySeven - Four - One == Zero), "32-27-4-1 != 0");

    TstCond (Failure, (Five == Four + One), "5 != 4+1");
    TstCond (Failure, (TwoForty == Four * Five * Three * Four), "240 != 20*12");
    TstCond (Failure, (TwoForty / Three - Four * Four * Five == Zero), "240/3 != 80");
    TstCond (Failure, ( TwoForty / Four - Five * Three * Four == Zero), "240/4 != 60");
    TstCond (Failure, ( TwoForty / Five - Four * Three * Four == Zero), "240/5 != 48");
