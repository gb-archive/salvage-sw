...
void part4(VOID) banked {
    ...
    TstCond (Failure, (Zero == SQRT(Zero)), "Square root of 0.0 wrong");
    TstCond (Failure, (- Zero == SQRT(- Zero)), "Square root of -0.0 wrong");
    TstCond (Failure, (One == SQRT(One)), "Square root of 1.0 wrong");
    MinSqEr = Zero;
    MaxSqEr = Zero;
    J = Zero;
    X = Radix;
